...
// ================================
// UPDATED: Fetch all necessary profile fields including MiddleName, LastName, Birthdate, Address, and Img
$sql = "SELECT FirstName, MiddleName, LastName, Email, Phone, Address, Birthdate, Balance, Img FROM user_accounts WHERE ID = ?";
